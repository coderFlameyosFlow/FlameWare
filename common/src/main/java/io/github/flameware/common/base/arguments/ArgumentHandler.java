...
public interface ArgumentHandler {
     ...
     */
    <T> BaseArgumentHandler addParserIfAbsent(Class<? extends T> clazz, Function<String, ? extends T> argument);
     ...
     * @param <T> the type of the argument
     */
    <T> BaseArgumentHandler addParserIfAbsent(@NotNull Map<Class<? extends T>, Function<String, ? extends T>> parser);
     ...
     * @return the argument handler for chaining
     */
    <T> BaseArgumentHandler addParser(Class<? extends T> clazz, Function<String, ? extends T> argument);
     ...
     * @param <T> the type of the argument
     */
    <T> BaseArgumentHandler addParser(Map<Class<? extends T>, Function<String, ? extends T>> parser);
}
